...
//printf("%.f|%.f|%.f|%.f|%.f\n", 44.5, 44.4, 44.6, 44.50001, 44.5 + 1e-52);
//ft_printf("|%.f|%.f|%.f|%.f|%.f|%.f|%.f|%.f|%.f|%.f|\n", 40.5, 41.5, 42.5, 43.5, 44.5, 45.4, 46.5, 47.5, 48.5, 49.5);
//printf("|%.f|%.f|%.f|%.f|%.f|%.f|%.f|%.f|%.f|%.f|\n", 40.5, 41.5, 42.5, 43.5, 44.5, 45.4, 46.5, 47.5, 48.5, 49.5);

//ft_printf("|%.f|%.f|%.f|%.f|%.f|%.f|%.f|%.f|\n", 44.5, 44.5000000000001, 45.5, 45.5000000001, 46.5, 46.50000000001, 47.5, 47.50000000001);
//printf("|%.f|%.f|%.f|%.f|%.f|%.f|%.f|%.f|\n", 44.5, 44.5000000000001, 45.5, 45.5000000001, 46.5, 46.50000000001, 47.5, 47.50000000001);
//ft_printf("|%.350f|\n", 1.e-57);
//printf("|%.350f|\n", 1.e-57);

//ft_printf("%.350f|%.350f|%.350f|%.350f|%.350f\n", 1.e-1, 1.e-2, 1.e-18, 1.e-57, 1.e-201);

//printf("%.350f|%.350f|%.350f|%.350f|%.350f\n", 1.e-1, 1.e-2, 1.e-18, 1.e-57, 1.e-201);
...
/*
ft_printf("%.600f\n", 1232342.);

printf("%.600f\n", 0.);


ft_printf("%.400f", 0.);

printf("%.400f", 0.);
*/
...
ft_printf("time is %k\n");
ft_printf("Encrpting : %K\n", "yolo");
ft_printf("Decrypting : %D\n", ")363)");
while(1)
